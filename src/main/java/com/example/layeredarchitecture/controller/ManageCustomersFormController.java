...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        /*Get all customers*/
        try {
            ArrayList<CustomerDTO> allCustomers = new ArrayList<>(customerDAO.loadAllCustomers());
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                customerDAO.saveCustomer(new CustomerDTO(id, name, address)); // create and pass a new CustomerDTO object to the saveCustomer method
